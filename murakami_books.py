...
BOOKS = [
    ...
    {"id": 19, "title": "1Q84 BOOK 1",                                   "year": 2009, "pub": "新潮文庫",    "cat": "長編小説"},
    {"id": 20, "title": "1Q84 BOOK 2",                                   "year": 2009, "pub": "新潮文庫",    "cat": "長編小説"},
    {"id": 21, "title": "1Q84 BOOK 3",                                   "year": 2010, "pub": "新潮文庫",    "cat": "長編小説"},
    {"id": 22, "title": "色彩を持たない多崎つくると、彼の巡礼の年",      "year": 2013, "pub": "文春文庫",    "cat": "長編小説"},
    {"id": 23, "title": "騎士団長殺し 第1部 顕れるイデア編",              "year": 2017, "pub": "新潮文庫",    "cat": "長編小説"},
    {"id": 24, "title": "騎士団長殺し 第2部 遷ろうメタファー編",          "year": 2017, "pub": "新潮文庫",    "cat": "長編小説"},
    {"id": 25, "title": "街とその不確かな壁",                             "year": 2023, "pub": "新潮社",      "cat": "長編小説"},
    # ── 短篇集 ────────────────────────────────────────────────────────────
    {"id": 26, "title": "中国行きのスロウ・ボート",                       "year": 1983, "pub": "中公文庫",    "cat": "短篇集"},
    {"id": 27, "title": "カンガルー日和",                                 "year": 1983, "pub": "講談社文庫",  "cat": "短篇集"},
    {"id": 28, "title": "螢・納屋を焼く・その他の短篇",                   "year": 1984, "pub": "新潮文庫",    "cat": "短篇集"},
    {"id": 29, "title": "回転木馬のデッド・ヒート",                       "year": 1985, "pub": "講談社文庫",  "cat": "短篇集"},
    {"id": 30, "title": "パン屋再襲撃",                                   "year": 1986, "pub": "文春文庫",    "cat": "短篇集"},
    {"id": 31, "title": "TVピープル",                                     "year": 1990, "pub": "文春文庫",    "cat": "短篇集"},
    {"id": 32, "title": "夜のくもざる",                                   "year": 1995, "pub": "平凡社文庫",  "cat": "短篇集"},
    {"id": 33, "title": "レキシントンの幽霊",                             "year": 1996, "pub": "文春文庫",    "cat": "短篇集"},
    {"id": 34, "title": "神の子どもたちはみな踊る",                       "year": 2000, "pub": "新潮文庫",    "cat": "短篇集"},
    {"id": 35, "title": "東京奇譚集",                                     "year": 2005, "pub": "新潮文庫",    "cat": "短篇集"},
    {"id": 36, "title": "夢で会いましょう",                               "year": 1981, "pub": "文春文庫",    "cat": "短篇集"},
    # ── エッセイ ──────────────────────────────────────────────────────────
    {"id": 37, "title": "村上朝日堂",                                     "year": 1984, "pub": "新潮文庫",    "cat": "エッセイ"},
    {"id": 38, "title": "村上朝日堂の逆襲",                               "year": 1986, "pub": "新潮文庫",    "cat": "エッセイ"},
    {"id": 39, "title": "意味がなければスイングはない",                    "year": 2008, "pub": "文春文庫",    "cat": "エッセイ"},
    {"id": 40, "title": "走ることについて語るときに僕の語ること",          "year": 2010, "pub": "文春文庫",    "cat": "エッセイ"},
    {"id": 41, "title": "職業としての小説家",                             "year": 2016, "pub": "新潮文庫",    "cat": "エッセイ"},
    {"id": 42, "title": "猫を棄てる",                                     "year": 2022, "pub": "文春文庫",    "cat": "エッセイ"},
]
...
# ─────────────────────────────────────────────────────────────────────────────
# データマイグレーション（v1→v2: 羊・世界の終りを上下巻に分割）
#
# v1 ID → v2 IDs の対応表
# 分割される本は上下巻どちらにも同じステータスをコピーする
# ─────────────────────────────────────────────────────────────────────────────
...
_V1_TO_V2 = {
     ...
     2: [ 2],  #  1973年のピンボール
     3: [ 3,  4],  #  羊をめぐる冒険 → 上・下
     4: [ 5,  6],  #  世界の終りとハードボイルド・ワンダーランド → 上・下
     5: [ 7],  #  ノルウェイの森 上
     6: [ 8],  #  ノルウェイの森 下
     7: [ 9],  #  ダンス・ダンス・ダンス 上
     8: [10],  #  ダンス・ダンス・ダンス 下
     9: [11],  #  国境の南、太陽の西
    10: [12],  #  ねじまき鳥クロニクル 第1部
    11: [13],  #  ねじまき鳥クロニクル 第2部
    12: [14],  #  ねじまき鳥クロニクル 第3部
    13: [15],  #  スプートニクの恋人
    14: [16],  #  海辺のカフカ 上
    15: [17],  #  海辺のカフカ 下
    16: [18],  #  アフターダーク
...
def _migrate(old: dict) -> dict:
    new = {'_version': DATA_VERSION}
    for old_id, new_ids in _V1_TO_V2.items():
        entry = old.get(str(old_id))
        if entry:
            for new_id in new_ids:
                new[str(new_id)] = dict(entry)
    return new
    ...
    if os.path.exists(DATA_PATH):
        try:
            with open(DATA_PATH, 'r', encoding='utf-8') as f:
                raw = json.load(f)
            if raw.get('_version', 1) < DATA_VERSION:
                _DATA = _migrate(raw)
                save_all()
            else:
                _DATA = raw
